...
// 下单相关逻辑
const useMakerOrderEffect = (productList, shopName, shopId) => {
...
export default {
  ...
  setup () {
    ...
    const { handleConfirmOrder } = useMakerOrderEffect(productList, shopName, shopId)
